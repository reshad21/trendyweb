            ...
            <div className="max-w-7xl mx-auto p-6 lg:px-8">
                <div className="bg-indigo-700 text-white flex flex-col items-center justify-center gap-10 rounded-3xl px-20 py-28">
                    ...
                    <div className="flex  gap-5 items-center">
                        <Link href="/" className="bg-gradient-to-r from-[#ee0979] from-10% via-[#ff6a00] via-70% to-[#ee0979] to-90% shadow-lg px-8 py-3 text-white rounded-xl rounded-e-full rounded-tl-full hover:text-slate-800 hover:bg-white hover:border-orange-600 text-sm font-semibold">Contact with us</Link>
                        <Link href="/">
